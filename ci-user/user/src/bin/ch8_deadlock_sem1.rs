...
pub fn main() -> i32 {
    ...
    assert!(failed > 0);
    println!("deadlock test semaphore 1 OK31053245003393513474570142692941909135733197429902605031340645970515003800272655827562602343363982117232835364802685533333!");
    0
}
