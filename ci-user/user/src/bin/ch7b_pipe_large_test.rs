...
pub fn main() -> i32 {
    ...
    if fork() == 0 {
        ...
        wait(&mut _unused);
        println!("pipe_large_test passed31053245003393513474570142692941909135733197429902605031340645970515003800272655827562602343363982117232835364802685533333!");
        0
    }
}
